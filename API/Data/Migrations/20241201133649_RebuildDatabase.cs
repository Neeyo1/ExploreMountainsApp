        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicProfile = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserMountains", x => new { x.UserId, x.MountainId });
                    table.ForeignKey(
                        name: "FK_UserMountains_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserMountains_Mountains_MountainId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserMountains_MountainId",
                table: "UserMountains",
                column: "MountainId");
        }
